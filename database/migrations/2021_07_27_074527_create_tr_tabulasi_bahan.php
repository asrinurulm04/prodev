...
class CreateTrTabulasiBahan extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tr_tabulasi_bahan', function (Blueprint $table) {
            $table->increments('id_tabulasi');
    ...
    {
        Schema::dropIfExists('tr_tabulasi_bahan');
    }
}
