...
class EmailController extends Controller
{
    ...
    public function emailpdf(Request $request,$id_project_pdf,$revisi, $turunan){
        ...
        $pdf            = ProjectPDF::join('tr_sub_pdf','tr_sub_pdf.pdf_id','=','tr_pdf_project.id_project_pdf')->where('id_project_pdf',$id_project_pdf)->where('revisi',$revisi)->where('turunan',$turunan)->first();
    ...
    public function approveemailpkp(Request $request,$id_project){// approve project PKP by  email
        ...
        try{ // mengirim email informasi penerimaan project
            Mail::send('email.infoemailpkp', [
                'info'=>'selamat project PKP anda telah disetujui.',
                'for' => $for,
                'app' => $isipkp,
    ...
    public function rejectemailpkp(Request $request,$id_project){ //reject project pkp dari email
        ...
        $isipkp = PkpProject::where('id_project',$id_project)->where('status_project','=','active')->get();
        try{ // mengirim email informasi penolakan project
            Mail::send('email.infoemailpkp', [
    ...
    public function approveemailpdf(Request $request,$id_project_pdf){ // approve project PDF by  email
    ...
    public function tempemail(){
        $email  = emailLaunching::all();
        return view('email.tempemail')->with([
            'email' => $email
        ]);
    }

    public function editTempemail(Request $request, $id){
        $edit         = emailLaunching::where('id',$id)->first();
        $edit->name   = $request->name;
        $edit->email  = $request->mail;
    ...
    public function addTempemail(Request $request){
        $add         = new emailLaunching;
        $add->name   = $request->name;
        $add->email  = $request->email;
        $add->status = 'active';
        $add->save();
        
        return redirect::back()->with('status', 'Add email success');
    }
}