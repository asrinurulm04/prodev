...
class BahanBakuController extends Controller
{
    ...
    public function bahan(){ // list bahan baku eksis
    ...
    public function active($id){ // meng-aktifkan data bahan baku
    ...
    public function nonactive($id){ // nonactive kan data bahan baku
        $bahan = Bahan::where('id',$id)->first();
    ...
    public function bahanrd(){ // menampilkan list bahan baku yang di buat RD
        $bahans  = Bahan::where('status_bb','baru')->select('nama_bahan','harga_satuan','supplier','id','PIC','curren_id')->get();
        $currens = Curren::all();
    ...
    public function addbahanrd(Request $request){ // menambahkan data bahan baku baru dan data lainnya
        $bahan = new Bahan;
    ...
    public function registrasi(){ // halaman registrasi bahan baku
    ...
    public function edit_bahan($id){ // halaman edit bahan baku
        $bahan            = Bahan::where('id',$id)->first();
    ...
    public function saveupdateBahan(Request $request,$id_bahan){ // update bahan baku dan data lainnya
