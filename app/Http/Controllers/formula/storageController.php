...
class storageController extends Controller
{
    ...
    public function showStorage($formulas,$pkp,$id){ //halaman storage
        $idfor       = $formulas;
    ...
    public function hasilnya(Request $request){ // menambahkan hasil data storage
    ...
    public function editdata(request $request, $id){ // edit data storage
    ...
    public function ajukanstorage(Request $request,$id_formula,$id_storage){ // mengajukan data storage ke PV
        ...
        try{ // PV akan menambatkan informassi via email ketika user mengirimkan data storage
