  ...
  <div class="col-md-12 col-xs-12">
    ...
    <div class="x_panel">
      ...
      <div class="col-md-6" align="right">
        ...
        <a href="{{ route('listpkprka')}}" class="btn btn-danger btn-sm" type="button"><li class="fa fa-arrow-left"></li> Back</a>
      </div>
      ...
      <div class="x_panel">
        <div class="col-md-5">
          <table>
              ...
              @if($listpkp->type==1) Maklon
              @elseif($listpkp->type==2) Internal
              @elseif($listpkp->type==3) Maklon/Internal
              @endif
              </td></tr>
