    ...
    <div class="x_panel" >
      <div class="row"  style="margin:20px">
        <div id="exTab2" class="container">
            ...
            <a class="btn btn-danger btn-sm" href="{{ route('rekappkp',[$pkp->id_project,$pkp->id_pkp])}}"><i class="fa fa-share"></i> Back</a>
                ...
                <div class="modal" id="NW{{$pkp->id_pkp}}{{$pkp->revisi}}{{$pkp->turunan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal form-label-left" method="POST" action="{{ Route('editt',$pkp->id_project)}}">
                        <div class="form-group row">
                ...
                <div class="modal" id="revisi{{$pkp->id_pkp}}{{$pkp->turunan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form class="form-horizontal form-label-left" method="POST" action="{{ Route('sentpkp',$pkp->id_project)}}">
                        <div class="form-group row">
