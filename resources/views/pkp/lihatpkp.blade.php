              ...
              <div class="panel-default">
                    ...
                    @if($pkp->status_project=='draf')
                      ...
                      <tr>
                        ...
                        <?php $remarks_forecash = []; foreach ($pkp1 as $key => $data) If (!$remarks_forecash || !in_array($data->remarks_forecash, $remarks_forecash)) { $remarks_forecash += array( $key => $data->remarks_forecash ); 
                    ...
                    <table class=" table table-bordered">
                      ...
                      <tr>
                        ...
                        <br>
                          ...
                          if($data->revisi!=$pkp->revisi){ echo"Remarks forecast1: <s><font color='#ffa2a2'>$data->remarks_forecash<br></font></s>"; } if($data->revisi==$pkp->revisi){ echo"Remarks forecast1: $data->remarks_forecash <br>";  } } ?>
                          @endif
                        </td>
                      </tr>
                      <tr>
