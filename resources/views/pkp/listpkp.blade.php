          ...
          <!-- Kumpulan Modal -->
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-3 col-sm-3 col-xs-12">Selling Channel*</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input required id="selling_channel" value="{{$lc->selling_channel}}" required="required" class="form-control col-md-12 col-xs-12" type="text" name="selling_channel" readonly>
                      </div>
                    </div>
                    <div class="item form-group">
            ...
            <div class="modal" id="imp{{ $pkp->id_project  }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
              <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Improvement <small>({{$pkp->project_name}})</small>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button></h4>
                  </div>
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="item form-group">
                      @foreach($email as $cc)
                        <input id="project" required="required" value="{{$cc->email}}" class="form-control col-md-12 col-xs-12" type="hidden" name="tempEmail[]">
                      @endforeach
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Cc (Email) *</label>
                      <textarea disabled class="col-md-9 col-sm-9 col-xs-12" rows="2">@foreach($email as $cc){{$cc->email}} ; @endforeach</textarea> &nbsp <br>
                      <center><a href="{{route('tempemail')}}" type="button"><li class="fa fa-edit"></li> Edit Template Email</a></center>
                    </div>
                    <div class="item form-group">
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <input id="project" class="form-control col-md-12 col-xs-12" type="email" name="tempEmail[]">
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-12">
                        <input id="project" class="form-control col-md-12 col-xs-12" type="email" name="tempEmail[]">
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <label class="control-label col-md-1 col-sm-1 col-xs-12">RML</label>
                      <div class="col-md-9 col-sm-9 col-xs-12">
                        <input required id="rml" required="required" class="form-control col-md-12 col-xs-12" type="text" name="rml" >
                      </div>
                    </div>
                    <div class="item form-group">
                    ...
                    <div class="item form-group">
                      <label class="control-label col-md-2 col-sm-2 col-xs-12">Selling Channel*</label>
                      <div class="col-md-10 col-sm-10 col-xs-12">
                        <input required id="selling_channel" required="required" class="form-control col-md-12 col-xs-12" type="text" name="selling_channel" >
                      </div>
                    </div>
                    <div class="item form-group">
