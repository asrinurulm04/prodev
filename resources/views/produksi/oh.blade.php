    ...
    <div class="card-block">
      ...
      <div class="x_content">
        ...
        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
            <li class="nav-item"><a class="nav-link" href="{{ route('produksi',$id_feasibility) }}">GRANULASI</a></li>
            ...
            <li class="nav-item"><a class="nav-link active" href="{{ route('oh',$id_feasibility) }}">ACTIVITY</a></li>
          </ul>
...
<br>
    ...
    <td class="text-center"><button type="button" class="btn btn-warning fa fa-edit" data-toggle="modal" data-target="#exampleModal2{{ $dO->id_oh  }}"  data-toggle="tooltip" data-placement="top" title="Edit"></button>
