              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <button type="button" class="btn btn-warning fa fa-folder-open" data-toggle="modal" data-target="#exampleModal{{ $box->id }}" data-toggle="tooltip" data-placement="top" title="Edit"></button>
                    <!-- modal -->
                    ...
                    <a href="{{ route('pesansdm.destroy', $box->id) }}" class="btn btn-danger fa fa-trash-o" data-toggle="tooltip" data-placement="top" title="Hapus"></a>
                  </td>  
                </tr>
                @endforeach
                </tr>
