...
<div class="row">
    ...
    <div class="x_panel" align="right">
      <a href="{{ route('formula.detail',[$formula->id,$pdf->id_project,$formula->workbook_id]) }}" class="btn btn-sm btn-success" type="button" title="Show"><li class="fa fa-book"></li> Workbook</a>
      <a type="button" href="{{ Route('lihatpdf',[$pdf->pdf_id,$pdf->revisi,$pdf->turunan]) }}" class="btn btn-info btn-sm"><li class="fa fa-eye"></li> PDF</a>
      <a type="button" href="{{route('listPdfFs',$pdf->pdf_id)}}" class="btn btn-danger btn-sm"><li class="fa fa-arrow-left"></li> Back</a>
		</div>
	</div>
</div>
...
<input id="id_fs" value="{{ $pdf->pdf_id }}" class="form-control col-md-12 col-xs-12" type="hidden" name="id_project">
        ...
        <div class="x_content">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <input type="text" value="{{$pdf->datapdf->project_name}}" class="form-control col-md-12 col-xs-12" readonly>
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
							 <input type="text" value="{{$pdf->background}}" class="form-control col-md-12 col-xs-12" readonly>
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-9 col-sm-9 col-xs-12">
							 <input id="configuration" class="form-control col-md-12 col-xs-12" value="{{ $pdf->kemas->primer }}{{ $pdf->kemas->s_primer }} X {{ $pdf->kemas->sekunder1 }}{{ $pdf->kemas->s_sekunder1}} X {{ $pdf->kemas->sekunder2 }}{{ $pdf->kemas->s_sekunder2 }} X {{ $pdf->kemas->tersier }}{{ $pdf->kemas->s_tersier }}" readonly>
            </div>
          </div>
					@endif
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
							 <input type="text" value="{{$pdf->target_price}}" name="pricelist" id="pricelist" class="form-control col-md-12 col-xs-12">
            </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
							 <input type="text" value="{{ $pdf->kemas->tersier }}" name="uom_box" id="uom_box" class="form-control col-md-12 col-xs-12" readonly>
            </div>
