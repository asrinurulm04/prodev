    ...
    <div class="card-block">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-2 col-sm-2 col-xs-12" id="tampilkan">
          <input class="form-control" placeholder='Berat Jenis' id="" value="{{$formula->berat_jenis}}" name="berat_jenis" type="number" disabled/>
      	</div>
  ...
  <div class="x_panel">
    <div class="card-block">
        ...
        <a class="btn btn-danger btn-sm" href="{{ route('showworkbook',$formula->workbook_id) }}"><i class="fa fa-ban"></i> Cencel</a>
				...
				<button type="submit" class="btn btn-primary btn-sm"><li class="fa fa-check"></li> Create And Next</button>
