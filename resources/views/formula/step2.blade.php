  ...
  <div class="col-md-8">
    <div class="tabbable">
      <ul class="nav nav-tabs wizard">
        <li class="completed"><a href="{{ route('step2',$idf) }}"><span class="nmbr">1</span>Penyusunan</a></li>
  ...
  <div class="x_panel">
    ...
    <div>
      <div class="row">      
        ...
        <div class="col-md-6">                                                                        
					<div style="float:right">
						@if ($mybase != 0)
						<a class="btn btn-success" type="button" id="buttonformcheckscale"><i class="fa fa-eye"></i> Check Scale</a>
						<a class="btn btn-warning" type="button" id="buttonformsavescale"><i class="fa fa-save"></i> Save Scale</a>
						@endif
						@if ($mybase != 0)
						<a type="button" class="btn btn-dark" id="buttongantibase"><i class="fa fa-exchange"></i> Ganti Base</a>
						<a type="button" class="btn btn-danger" href="{{ route('hapusbase',$idf) }}" onclick="return confirm('Hapus Base Perhitungan ?')"><i class="fa fa-times"></i> Hapus Base</a>
						@endif
					</div>                                    
				</div>
				<div class="col-md-1">
      ...
      <div class="row">
        <div class="col-md-8">
          @if($ada<1)                                    
          <a type="button" class="btn btn-warning btn-sm" href="{{ route('getTemplate',$idf) }}"><i class="fa fa-download"></i> Import Template Formula</a>                                    
          @endif                                                      
