  ...
  <div class="x_title">
    ...
    <div class="col-md-3">
      	...
      	<a class="btn btn-warning btn-sm" href="{{ route('nutfact_bayangan_pkp',$formula->id) }}" title="Download Nutfact"><i class="fa fa-download"></i> Nutfact</a>
				...
				<a href="{{ route('rekappkp',[$id,$pro]) }}" type="button" class="btn btn-sm btn-danger"><li class="fa fa-arrow-left"></li> Back</a>
    ...
    <div class="row" style="margin:20px">
			<div id="exTab2" class="container">	
				<ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
					...
					@if(auth()->user()->role->namaRule == 'manager' || auth()->user()->role->namaRule == 'user_produk' || auth()->user()->role->namaRule == 'user_rd_proses')
				...
				<div class="tab-content ">
					<div class="tab-content ">
						...
						<div class="tab-pane" id="5">
							<h4><i class="fa fa-glass"></i> PANEL</h4>
							<div class="row">
								<div class="col-md-12">
									<table class="table table-bordered" style="font-size:12px">
										<thead>
						...
						<div class="tab-pane" id="6">
							<h4><i class="fa fa-flask"></i> Storage</h4>
							<div class="row">
								<div class="col-md-12">
									<table class="table table-bordered" style="font-size:12px">
										<thead>
