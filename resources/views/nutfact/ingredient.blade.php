...
<div class="row">
	<div class="col-md-14">
		<div class="showback">
			<div class="row">
			  <div class="col-md-6"><h4><i class="fa fa-cube"></i> Data Ingredient</h4> </div>
			  <div class="col-md-6 text-right"><h5><i class="fa fa-home"></i> / <a href="{{url('/akg')}}">Data Ingredient</a></h5></div>
			</div>
		</div>
	</div>
</div>
		...
		<div class="showback" style="border-radius:3px;">
			...
			<table class="table table-hover table-bordered table-condensed" id="Table">
				...
				<tr>
					...
					<td class="text-center">{{$data->ingredient}}</td>
