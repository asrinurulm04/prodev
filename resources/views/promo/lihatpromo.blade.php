              ...
              <div class="modal" id="NW{{ $promo->id_pkp_promo  }}{{$promo->turunan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <form class="form-horizontal form-label-left" method="POST" action="{{Route('sentPromoToRD',[$promo->id_pkp_promo, $promo->revisi,$promo->turunan])}}" novalidate>
              ...
              <div class="modal" id="revisi{{ $promo->id_pkp_promo  }}{{$promo->turunan}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form-horizontal form-label-left" method="POST" action="{{Route('sentPromoToRD',['id_pkp_promo' => $promo->id_pkp_promo, 'revisi' => $promo->revisi, 'turunan' => $promo->turunan])}}" novalidate>
                      <div class="form-group row">
