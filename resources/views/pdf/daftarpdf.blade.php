            ...
            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                @endif
                  ...
                  <td>
                    @if($sample->kategori!='fg') {{$sample->kategori}}
                    @elseif($sample->kategori=='fg') Finished Good
                    @endif
                  </td>
            ...
            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
              ...
              <tbody>
                ...
                @endif
                  ...
                  <td>
                    @if($sample1->kategori!='fg') {{$sample1->kategori}}
                    @elseif($sample1->kategori=='fg') Finished Good
                    @endif
                  </td>
                  ...
                  @if($sample1->vv=='proses')
                    ...
                    <!-- Modal Selesai -->
                    <button class="btn btn-success btn-sm" title="Approve" data-toggle="modal" data-target="#approve{{ $sample1->id  }}"><i class="fa fa-check"></i></a></button>
                    <!-- Modal -->
                    <div class="modal" id="approve{{ $sample1->id  }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
...
<div class="modal" id="data{{ $data->id_project_pdf  }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="form-horizontal form-label-left" method="POST" action="{{ Route('EditTimeline',$data->id_project_pdf)}}" novalidate>    
      <div class="modal-body">
