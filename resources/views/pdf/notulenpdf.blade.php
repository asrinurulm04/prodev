              ...
              <table class="Table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><input type="text" disabled name="datapdf[{{$loop->index}}][background]" class="form-control" value="{{$Dpdf->background}}"></td>
                    <td>
                      @if($Dpdf->launch!=NULL)
                      <input type="text" disabled name="scores[{{$loop->index}}][launch]" class="form-control" value="{{$Dpdf->launch}}">
                      <input type="text" disabled name="scores[{{$loop->index}}][years]" class="form-control" value="{{$Dpdf->years}}">
                      @elseif($Dpdf->launch==NULL)
                      <input type="text" disabled name="scores[{{$loop->index}}][tgl_launch]" class="form-control" value="{{$Dpdf->tgl_launch}}">
                      @endif
                    </td>
                    <td><textarea name="note[{{$loop->index}}][note]" value="{{$Dpdf->pdf_id}}" id="" cols="40" rows="2"></textarea>  </td>
                    <input type="hidden" value="{{$Dpdf->pdf_id}}" name="note[{{$loop->index}}][pdf]">
                  </tr>
                  @endforeach
                </tbody>
