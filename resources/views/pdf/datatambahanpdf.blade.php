  ...
  <div class="x_panel">
    <div class="x_title">
      ...
      <form method="post" action="{{url('uploadpdf')}}" enctype="multipart/form-data">
        ...
        <input type="hidden" value="{{$turunan->turunan}}" name="turunan">
...
<div class="col-md-12">
  <div class="x_panel">
    ...
    @else
      <a href="{{route('rekappdf',$id_pdf)}}" class="btn btn-primary col-md-12 btn-sm"><li class="fa fa-check"></li> Save And Finish</a>
    @endif
  </div>
</div>
@endsection