    ...
    <div class="x_content">
      <div class="col-md-4 col-sm-4 col-xs-12 profile_left">
        <div class="profile_img">
          <div id="crop-avatar">
            <!-- Current avatar -->
            <center><a href="{{route('lala')}}"><img class="img-responsive avatar-view" src="../img/prodev.png" alt="Avatar" title="Change the avatar"></a></center>
          </div>
        </div>
      ...
      <div class="col-md-8 col-sm-8 col-xs-12">
        <div class="" role="tabpanel" data-example-id="togglable-tabs">
          <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
            <li role="presentation" class="active"><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">Edit Profile {{ Auth::user()->name }}</a>
            </li>
          </ul>
          <div class="col-md-8 centered">
            <div class="col-lg-12 etailed">
              <div class="form">
