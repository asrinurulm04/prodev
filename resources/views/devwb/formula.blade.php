          ...
          <table class="table table-bordered" style="font-size:12px">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {{csrf_field()}}
                  <a class="btn btn-info btn-sm" href="{{ route('formula.detail',[$formula['workbook_id'],$formula['id']]) }}"><i style="font-size:14px;" class="fa fa-eye"></i></a>                                            
                  @if($formula['status']!='proses')                                                
                <a class="btn btn-danger btn-sm" href="{{ route('deleteFormula',$formula['id']) }}"><i style="font-size:14px;" class="fa fa-trash"></i>{{$formula['id']}}</a>
                  @endif
                </td>
              </tr>
              @endforeach
